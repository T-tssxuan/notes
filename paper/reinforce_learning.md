...
### 4. End-to-End Reinforcement Learning for Automatic Taxonomy Induction
...
### 5. The Arcade Learning Environment: An Evaluation Platform for General Agents, 2013
...
### 7. Rainbow: Combining Improvements in Deep Reinforcement Learning, 2018
...
### 8. PRIORITIZED EXPERIENCE REPLAY, 2016
...
### 10. Revisiting the Arcade Learning Environment: Evaluation Protocols and Open Problems for General Agents, 2018
...
### 11. Deep Reinforcement Learning with Double Q-learning, 2015
...
### 12. Distributed Deep Q-Learning, 2015
- 使用分布式训练，借助DistBelief框架
- 类似于tensorflow的分布式
- 每个worker单独自己的experience replay

### 13. A Distributional Perspective on Reinforcement Learning, 2017
- 把强化学习从均值转移到分布
...
### 14. Proximal Policy Optimization Algorithms, 2017
- 
